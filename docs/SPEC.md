...
| 8 | Full audit AR 1–20, AT report | Done: `docs/AUDIT_AR_AT.md`. Now 15 PASS, 4 PARTIAL, 1 FAIL, after fixes 1–3:<ul><li>0014: APPROVAL → RUN;</li><li>0015/0016: engine write path;</li><li>0017: audit-v2, the operator, and the contract's audit export.</li></ul> | FAIL: AR-18 (no protected-term scan). NOT RUN: live engine |
