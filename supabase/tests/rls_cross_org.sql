...
begin
  ...
  foreach o in array array[org_a, org_b] loop
    ...
    -- FAIL loop tables (0019); seeded directly as owner, closed with a verified PASS and a 38 step so knowledge is allowed
    ...
    insert into public.fail_case_steps (organization_id, case_id, seq, step) values (o, v_case, 2, 'FILTER');
