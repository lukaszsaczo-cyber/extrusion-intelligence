...
begin
  ...
  foreach o in array array[org_a, org_b] loop
    ...
    -- FAIL loop tables (0019/0021); seeded directly as owner, closed with a verified PASS and a passed 38 so knowledge is allowed
    ...
    insert into public.fail_case_steps (organization_id, case_id, seq, step, payload) values (o, v_case, 2, 'FILTER', '{"result":"PASSED"}'::jsonb);
    insert into public.knowledge_entries (organization_id, case_id, content) values (o, v_case, '{"seed":true}'::jsonb);
