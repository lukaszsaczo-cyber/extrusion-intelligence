...
// stage 7 audit seal and permission matrix, and the run/plan guard (0014).
...
process.exit([result, approval, verification, audit, matrix, runGuard].every((r) => r.verdict === "PASS") ? 0 : 1);
